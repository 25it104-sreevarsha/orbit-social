  ...
  return (
    ...
    >
      <motion.button
        ...
        style={{
          width: expanded ? undefined : 36,
          height: expanded ? undefined : 36,
      ...
      {!expanded && (
        <div
          className="absolute top-full mt-1 left-1/2 -translate-x-1/2 whitespace-nowrap text-[10px] text-slate-500 pointer-events-none"
        >
          {user.name.split(' ')[0]}
        </div>
      )}
