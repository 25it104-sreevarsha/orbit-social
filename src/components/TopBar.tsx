    ...
    <>
      <div className="fixed top-0 left-0 right-0 z-50 flex items-center gap-3 px-4 sm:px-6 py-3 bg-gradient-to-b from-space-950/90 to-transparent backdrop-blur-sm">
        <button
          ...
          className="flex items-center gap-2 text-white font-display font-bold text-lg sm:text-xl shrink-0 rounded-full focus-visible:outline-2 focus-visible:outline-offset-2"
        >
        ...
        {showSearch && (
          <div className="flex-1 min-w-0 max-w-md mx-auto relative">
            ...
            <input
              ...
              className="w-full min-w-0 bg-space-800/60 border border-space-600 rounded-full pl-10 pr-4 py-2 text-sm text-slate-200 placeholder:text-slate-500 focus:outline-none focus:border-accent-violet/50 transition-colors"
