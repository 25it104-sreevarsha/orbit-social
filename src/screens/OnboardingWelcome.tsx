    ...
    <div className="relative min-h-screen bg-space-950 flex flex-col items-center justify-center px-6 overflow-hidden">
      ...
      >
        ...
        <motion.button
          ...
          className="relative px-8 py-3.5 rounded-full text-white font-medium text-lg overflow-hidden group focus-visible:outline-2 focus-visible:outline-offset-2"
